...
```{r}
res <- readLines(con = "data/cl_info_other.csv", n = 10L, encoding = "UTF-8")
...
Cl_info = read.table(file = "data/cl_info_other.csv", sep = ",", stringsAsFactors = F, header = T, colClasses = c("character", "integer", "Date", "character", "Date", "character", "integer", "numeric", "integer", "numeric", "integer", "numeric", "integer", "numeric", "integer", "numeric"), encoding = "UTF-8")
head(Cl_info)
str(Cl_info)
```
