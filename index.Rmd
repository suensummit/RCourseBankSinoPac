...
```{r, eval=FALSE}
 = read.csv('檔案路徑', colClasses = c("factor","integer","integer","numeric","numeric","numeric","numeric","integer","numeric","integer","integer","numeric","numeric", "integer","integer","numeric","numeric","numeric", "numeric","numeric","numeric"), fileEncoding = 'utf8')
```
