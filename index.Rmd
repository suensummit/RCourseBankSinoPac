...
```{r}
filename <- "~/Downloads/29010.xls"
raw <- readLines(filename, n = 10, encoding = "BIG-5")
iconv(raw[1], from = "BIG-5", to = "UTF-8")
```
...
library(xlsx)
library(magrittr)
credit_10401 <- read.xlsx2("~/Downloads/10401信用卡重要資訊揭露.xlsx", sheetIndex = 1, startRow = 8, endRow = 45, as.data.frame = TRUE)
# 放 View 的 table 截圖
# View(credit_10401)
str(credit_10401)
...
```{r}
library(XLConnect)
wb = XLConnect::loadWorkbook("~/Downloads/29010.xls")
...
library(readxl)
filename <- "~/Downloads/29010.xls"
filename <- "~/Downloads/10401信用卡重要資訊揭露.xlsx"
...
# View(resxl)
resxl_2 <- read_excel("~/Downloads/29010.xls", sheet = 2, col_names = FALSE)
# View(resxl_2)
str(resxl_2)
```
